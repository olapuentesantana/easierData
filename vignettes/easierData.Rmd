...
- name: Óscar Lapuente-Santana
  affiliation: Computational Biology group, Department of Biomedical Engineering, Eindhoven University of Technology (BME, TU/e)
...
```{r, eval=TRUE}
install.packages("../easierData_0.9.0.tar.gz", repos = NULL, type="source")
```
