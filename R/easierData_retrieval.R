...
#'
#' @source IMvigor210CoreBiologies package:
#' http://research-pub.gene.com/IMvigor210CoreBiologies/ under the CC-BY license.
#'
#' @examples
#' if (interactive()) {
...
#' A pan-cancer network is also available and this is based on the union of all
#' ligand-receptor pairs present across the cancer-specific networks.
#'
#' @references Ramilowski, Jordan A., Tatyana Goldberg, Jayson Harshbarger,
#' Edda Kloppmann, Marina Lizio, Venkata P. Satagopam, Masayoshi Itoh, et al. 2015.
#' “A Draft Network of Ligand–Receptor-Mediated Multicellular Signalling in Human.”
#' Nature Communications 6 (1): 7866. https://doi.org/10.1038/ncomms8866.
#'
#' @references Barretina, J., Caponigro, G., Stransky, N. et al. The Cancer Cell
...
#' Genenames.org: the HGNC and VGNC resources in 2021. Nucleic Acids Res.
#' PMID: 33152070 PMCID: PMC7779007 DOI: 10.1093/nar/gkaa980
#'
...
#'
#' @references Cabrita, Rita, Martin Lauss, Adriana Sanna, Marco Donia, Mathilde Skaarup Larsen, Shamik Mitra, Iva Johansson,
#' et al. 2020. “Tertiary Lymphoid Structures Improve Immunotherapy and Survival in Melanoma.” Nature 577 (7791):
#'   561–65. https://doi.org/10.1038/s41586-019-1914-8.
#'
#' @references McClanahan, Mark Ayers AND Jared Lunceford AND Michael Nebozhyn AND Erin Murphy AND Andrey Loboda AND David R.
#' Kaufman AND Andrew Albright AND Jonathan D. Cheng AND S. Peter Kang AND Veena Shankaran AND Sarina A. Piha#' -Paul
#' AND Jennifer Yearley AND Tanguy Y. Seiwert AND Antoni Ribas AND Terrill K. 2017. “IFN-γ–Related mRNA Profile
#' Predicts Clinical Response to PD-1 Blockade.” The Journal of Clinical Investigation 127 (8): 2930–40.
#' https://doi.org/10.1172/JCI91190.
#'
#' @references Roh, Whijae, Pei-Ling Chen, Alexandre Reuben, Christine N. Spencer, Peter A. Prieto, John P. Miller,
#' Vancheswaran Gopalakrishnan, et al. 2017. “Integrated Molecular Analysis of Tumor Biopsies on Sequential CTLA#' -4
#' and PD-1 Blockade Reveals Markers of Response and Resistance.” Science Translational Medicine 9 (379).
#' https://doi.org/10.1126/scitranslmed.aah3560.
#'
#' @references Davoli, Teresa, Hajime Uno, Eric C. Wooten, and Stephen J. Elledge. 2017. “Tumor Aneuploidy Correlates with
#' Markers of Immune Evasion and with Reduced Response to Immunotherapy.” Science 355 (6322).
#' https://doi.org/10.1126/science.aaf8399.
#'
#' @references Messina, Jane L., David A. Fenstermacher, Steven Eschrich, Xiaotao Qu, Anders E. Berglund, Mark C. Lloyd,
#' Michael J. Schell, Vernon K. Sondak, Jeffrey S. Weber, and James J. Mulé. 2012. “12-Chemokine Gene Signature
#' Identifies Lymph Node-Like Structures in Melanoma: Potential for Patient Selection for Immunotherapy?”
#' Scientific Reports 2 (1): 765. https://doi.org/10.1038/srep00765.
#'
#' @references Auslander, Noam, Gao Zhang, Joo Sang Lee, Dennie T. Frederick, Benchun Miao, Tabea Moll, Tian Tian, et al. #' 2018.
#' “Robust Prediction of Response to Immune Checkpoint Blockade Therapy in Metastatic Melanoma.” Nature Medicine #' 24
#' (10): 1545–49. https://doi.org/10.1038/s41591-018-0157-9.
#'
#' @references Fu, Yelin, Lishuang Qi, Wenbing Guo, Liangliang Jin, Kai Song, Tianyi You, Shuobo Zhang, Yunyan Gu, Wenyuan #' Zha
#' , and Zheng Guo. 2019. “A Qualitative Transcriptional Signature for Predicting Microsatellite Instability #' Status
#' of Right-Sided Colon Cancer.” BMC Genomics 20 (1): 769. https://doi.org/10.1186/s12864-019-6129-8.
#'
#' @references Jerby-Arnon, Livnat, Parin Shah, Michael S. Cuoco, Christopher Rodman, Mei-Ju Su, Johannes C. Melms, Rachel
